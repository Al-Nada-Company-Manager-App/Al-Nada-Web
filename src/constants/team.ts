...
export const TEAM_MEMBERS: TeamMember[] = [
  {
    ...
    photo: "/img/team/CEO&Founder.webp",
    socials: {
  ...
  },
  {
    ...
    photo: "/img/team/secretary.webp", // TODO: add photo later
    socials: {
  ...
  },
  {
    ...
    photo: "/img/team/technialsupport.webp",
    socials: {
      linkedin: "#",
      email: "sales@alnadascientific.com",
    },
  },
  {
    ...
    // photo: "/img/team/environmentalEngineer.webp",
    photo: "/img/team/salesrepresentative.webp",
    socials: {
  ...
  },
  {
    ...
    photo: "/img/team/IT Manager.webp",
    socials: {
  ...
  },
  {
    ...
    photo: "/img/team/digitalMarketing.webp",
    socials: {
...
export const DEPARTMENTS = [
  {
    ...
    image: "/img/about/about-3.webp",
  },
  {
    title: { en: "Environmental Measurements", ar: "القياسات البيئية" },
    subtitle: { en: "Department", ar: "القسم" },
    image: "/img/about/about-4.webp",
  },
  {
    title: {
    ...
    subtitle: { en: "Department", ar: "القسم" },
    image: "/img/about/about-5.webp",
  },
  {
    title: { en: "Maintenance & Calibration", ar: "الصيانة والمعايرة" },
    subtitle: { en: "Department", ar: "القسم" },
    image: "/img/about/about-6.webp",
  },
];
